        ...
        <Box display="flex" gap={0} maxWidth={720}>
          ...
          <PhilosophySection title="Convention plutôt que configuration">
            <Typography style={text['Corps de texte'].MD.Regular}>
              ...
              <Typography style={text['Corps de texte'].MD.Regular}>Convention over Configuration</Typography> : le
              thème par défaut est pensé pour fonctionner sans ajustement. La customisation reste possible — palette,
          ...
          <PhilosophySection title="Des choix assumés">
            <Typography style={text['Corps de texte'].MD.Regular}>
              ...
              systématiquement un <Typography style={text['Corps de texte'].MD.Regular}>strokeWidth à 1.5</Typography> —
